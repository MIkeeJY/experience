...
public class OssHandleException {
    ...
    public static String handleException(OSSException ossException) {
        ...
        if (ossException.getExceptionType() == ExceptionType.LOCAL_EXCEPTION) {
            ...
            return objectKey + mesString + localException;
            ...
            return objectKey + statusCode + message;
        }
        EventBus.getDefault().post(ossException);
        return "";
    }
}
